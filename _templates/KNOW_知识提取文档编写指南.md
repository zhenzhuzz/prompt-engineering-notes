...
- [2. 文档结构规范](#2-文档结构规范)
  - [2.1 文档头部元信息](#21-文档头部元信息必填)
  - [2.2 文档开头：Golden Rule 或 One Paragraph Takeaway](#22-文档开头golden-rule-或-one-paragraph-takeaway必选其一)
  - [2.3 核心章节结构](#23-核心章节结构)
- [3. 核心内容要素](#3-核心内容要素)
- [4. 写作风格与技巧](#4-写作风格与技巧)
- [5. 质量检查清单](#5-质量检查清单)
...
### 2.2 文档开头：Golden Rule 或 One Paragraph Takeaway（必选其一）

**目的**：让读者在 10 秒内决定是否值得继续阅读。

#### 选择标准

```
选择哪种开头？
├── 文档回答 "何时/如何做决策"？ → Golden Rule
│   例：自动化指南、流程规范、最佳实践
│
└── 文档传递 "独特洞见/新认知"？ → One Paragraph Takeaway
    例：技术总结、研究报告、概念解释
```

#### Golden Rule 模板

适用于：决策指南、流程规范、"何时做什么"类文档
...
**示例**:
> **反直觉洞见**: Prompt 优化的大部分时间不应该花在写 prompt 上。
>
> 真正的 leverage 在于构建 evaluation 系统。好的 eval 让你能快速迭代，而不是凭感觉调整 prompt。如果你花 80% 时间写 prompt，你的方向错了。
>
> **核心公式**: Eval 质量 × 迭代速度 = Prompt 效果
...
```markdown
## Golden Rule / One Paragraph Takeaway (二选一，见 §2.2)
...
```
✔ 包含 Golden Rule 或 One Paragraph Takeaway (二选一)
✔ 包含 The Essence 核心精华图
...
| v1.3.0 | 2025-12-18 | 新增 §2.2 文档开头规范：Golden Rule 或 One Paragraph Takeaway（必选其一） |